        ...
        <div className='w-full flex items-center justify-center'>
            <form className='rounded-lg border-black p-10'>
                ...
                <div>
                    ...
                    <input value={newpassword} onChange={e => setNewPassword(e.target.value)} placeholder='Enter password' id='newpassword' type='password' />
                </div>
                <div>
                    <label htmlFor='confirm'>Confirm password</label>
                    <input value={confirm} onChange={e => setConfirm(e.target.value)} placeholder='Enter password' id='confirm' type='password' />
                </div>
